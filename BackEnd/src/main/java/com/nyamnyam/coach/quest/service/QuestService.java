...
import com.nyamnyam.coach.quest.dto.response.GeneratedQuestResponse;
...
import com.nyamnyam.coach.quest.dto.response.QuestContributionResponse;
...
import com.nyamnyam.coach.quest.dto.response.QuestSummaryResponse;
...
public class QuestService {
    ...
    private QuestSummaryResponse toSummaryResponse(QuestRow row) {
        return new QuestSummaryResponse(
                ...
                row.getRewardCoin(),
                row.getStatus(),
                row.getQuestTemplateId(),
                row.getConditionCategory(),
                row.getMetricType(),
                row.getComparisonType(),
                row.getAggregationType(),
                row.getEvaluationScope(),
                row.getThresholdValue(),
                row.getThresholdMinValue(),
                row.getThresholdMaxValue(),
