...
CREATE TABLE health_profiles (
    ...
    improvement_focus VARCHAR(30),
    health_concerns_json JSON,
    desired_habits_json JSON,
    habit_blockers_json JSON,
    diet_styles_json JSON,
    restricted_foods_json JSON,
    allergies_json JSON,
    meal_record_frequency VARCHAR(30),
    calorie_tracking_experience VARCHAR(30),
