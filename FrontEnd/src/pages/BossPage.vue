  ...
  <section v-else class="boss-battle-screen" :style="{ backgroundImage: `url(${battleBossAssets.background})` }">
    ...
    <div class="battle-grid">
      <main class="battle-left">
        <div class="arena" :class="{ cleared: isBattleCleared }">
