  ...
  <section v-else>
    ...
    <div class="battle-grid">
      <main class="battle-left">
        ...
        <div class="arena" :style="{ backgroundImage: `url(${dragonBackground})` }"><BossMonster :size="300" :hp="hpPercent" /></div>
...
import dragonBackground from '../assets/dragon-background.png'
...
.boss-art { border-radius: 18px; overflow: hidden; padding: 36px 32px; background: #fff4df; border: 1.5px solid var(--border); box-shadow: var(--shadow-lg); display: flex; flex-direction: column; align-items: center; gap: 12px; }
