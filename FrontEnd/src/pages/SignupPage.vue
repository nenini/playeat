...
.auth-page {
  min-height: 100vh;
  background: radial-gradient(circle at 18% 25%,rgba(243,211,111,.34),transparent 24rem),radial-gradient(circle at 82% 70%,rgba(56,169,104,.12),transparent 25rem),linear-gradient(160deg,#fffaf3,#fff0e2);
  display: flex;
