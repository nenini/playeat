export interface CoinBalance { userId?: number; balance: number; updatedAt?: string }
export interface CoinTransactionParams { page?: number; size?: number; transactionType?: string }
